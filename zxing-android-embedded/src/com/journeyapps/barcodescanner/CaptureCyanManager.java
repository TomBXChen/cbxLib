 ...
 */
public class CaptureCyanManager {
    private static final String TAG = CaptureCyanManager.class.getSimpleName();

    private static int cameraPermissionReqCode = 250;

    private Activity activity;
    private CyanBarcodeView barcodeView;
    private BarcodeSucceedCallback mBarcodeSucceedCallback;
    ...
    public CaptureCyanManager(Activity activity, CyanBarcodeView barcodeView, BarcodeSucceedCallback callback) {
        this.activity = activity;
        this.barcodeView = barcodeView;
        this.mBarcodeSucceedCallback = callback;
        final BarcodeView barcodeView1 = barcodeView.getBarcodeView();
        barcodeView1.addStateListener(stateListener);
    ...
    protected void returnResult(BarcodeResult rawResult) {
        if(mBarcodeSucceedCallback!=null){
            mBarcodeSucceedCallback.barcodeSucceed(rawResult.getText());
        }else{
    ...
    public static void setCameraPermissionReqCode(int cameraPermissionReqCode) {
        CaptureCyanManager.cameraPermissionReqCode = cameraPermissionReqCode;
    }
}

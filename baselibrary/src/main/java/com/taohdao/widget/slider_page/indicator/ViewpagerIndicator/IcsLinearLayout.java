...
/**
 * A simple extension of a regular linear layouts that supports the divider API
 * of Android 4.0+. The dividers are added adjacent to the children by changing
 * their layouts params. If you need to rely on the margins which fall in the
 * same orientation as the layouts you should wrap the child in a simple

package com.taohdao.library.widget.linkage.adapter.viewholder;
/*
...
public class LinkagePrimaryViewHolder extends BaseViewHolder {
    ...
    public LinkagePrimaryViewHolder(@NonNull View itemView, ILinkagePrimaryAdapterConfig config) {
        ...
        //need bind root layouts by users, because rootLayout may not viewGroup, which can not getChild(0).

...
import com.taohdao.library.widget.rebound.SimpleSpringListener;
...
import com.taohdao.library.widget.rebound.SpringUtil;

/**
 * Created by taohuadao on 2016/5/11.
 */
public class ToggleButton extends View {
    ...
    public void setup(AttributeSet attrs) {
        ...
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_borderWid, borderWidth);
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        offLineWidth = height-borderWidth*4;
    }

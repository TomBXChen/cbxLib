package com.taohdao.library.widget.linkage;
/*
...
import com.taohdao.library.widget.linkage.adapter.LinkagePrimaryAdapter;
import com.taohdao.library.widget.linkage.adapter.LinkageSecondaryAdapter;
...
import com.taohdao.library.widget.linkage.defaults.DefaultLinkagePrimaryAdapterConfig;
import com.taohdao.library.widget.linkage.defaults.DefaultLinkageSecondaryAdapterConfig;
...
public class LinkageRecyclerView<T extends BaseGroupedItem.ItemInfo> extends RelativeLayout {
    ...
    public void init(List<BaseGroupedItem<T>> linkageItems,
                     ...
                     ILinkageSecondaryAdapterConfig secondaryAdapterConfig) {
        if (CommonUtils.transform(linkageItems).size() <= 0) return;

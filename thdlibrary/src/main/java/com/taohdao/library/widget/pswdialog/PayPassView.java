package com.taohdao.library.widget.pswdialog;
...
public class PayPassView extends RelativeLayout {
    ...
    private TextView mTvPayText;//支付金额
    ...
    private void initView() {
        ...
        mTvPayText = (TextView) mPassLayout.findViewById(R.id.tv_payText);//忘记密码

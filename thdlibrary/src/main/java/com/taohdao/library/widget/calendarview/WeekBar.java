 ...
 */
package com.taohdao.library.widget.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        ...
        if ("com.taohdao.library.widget.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.taohdao.library.widget.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
    ...
    protected void onWeekStartChange(int weekStart) {
        if (!"WeekBar".equalsIgnoreCase(getClass().getName())) {
            return;
        }
        for (int i = 0; i < getChildCount(); i++) {

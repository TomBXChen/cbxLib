 ...
 */
public class THDPopup extends THDBasePopup {
    ...
    public THDPopup(Context context) {
        this(context, DIRECTION_NONE);
    }

    public THDPopup(Context context, @Direction int preferredDirection) {
        super(context);
    ...
    private void setAnimationStyle(int screenWidth, int requestedX) {
        ...
        switch (mAnimStyle) {
            case ANIM_GROW_FROM_LEFT:
                mWindow.setAnimationStyle(onTop ? R.style.THD_Animation_PopUpMenu_Left : R.style.THD_Animation_PopDownMenu_Left);
                break;

            case ANIM_GROW_FROM_RIGHT:
                mWindow.setAnimationStyle(onTop ? R.style.THD_Animation_PopUpMenu_Right : R.style.THD_Animation_PopDownMenu_Right);
                break;

            case ANIM_GROW_FROM_CENTER:
                mWindow.setAnimationStyle(onTop ? R.style.THD_Animation_PopUpMenu_Center : R.style.THD_Animation_PopDownMenu_Center);
                break;
            case ANIM_AUTO:
    ...
    /**
     * the root layouts: must provide ids: arrow_down(ImageView), arrow_up(ImageView), box(FrameLayout)
     *
     * @return
     */
    @LayoutRes
    protected int getRootLayout() {
        return R.layout.thd_popup_layout;
    }

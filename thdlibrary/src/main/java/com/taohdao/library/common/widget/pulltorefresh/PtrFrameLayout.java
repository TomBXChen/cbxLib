...
import com.taohdao.library.common.widget.pulltorefresh.util.PtrCLog;


/**
 * This layouts view for "Pull to Refresh(Ptr)" support all of the view, you can contain everything you want.
...
public class PtrFrameLayout extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        if (childCount > 2) {
            ...
            errorView.setText("The content view in PtrFrameLayout is empty. Do you forget to specify its id in xml layouts file?");
            mContent = errorView;
            addView(mContent);
        }
    ...
    private void layoutChildren() {
        ...
        if (mHeaderView != null) {
            ...
            // enhance readability(header is layouts above screen when first init)
...
//                }
                ...
                if (((moveUp && canMoveUp) || moveDown )&&isPullToRefresh()) {
                    movePos(offsetY);
                    return true;
                }
        }
    ...
    public void autoRefreshDelay(long delayMillis) {

 ...
 * @date 2015-07-09
 */
public class THDRadiusImageView extends AppCompatImageView {
    ...
    public THDRadiusImageView(Context context) {
        this(context, null, R.attr.THDRadiusImageViewStyle);
    }

    public THDRadiusImageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.THDRadiusImageViewStyle);
    }

    public THDRadiusImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.THDRadiusImageView, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.THDRadiusImageView_thd_border_width, 0);
        mBorderColor = array.getColor(R.styleable.THDRadiusImageView_thd_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.THDRadiusImageView_thd_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(R.styleable.THDRadiusImageView_thd_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(R.styleable.THDRadiusImageView_thd_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(R.styleable.THDRadiusImageView_thd_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.THDRadiusImageView_thd_is_circle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.THDRadiusImageView_thd_is_oval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(R.styleable.THDRadiusImageView_thd_corner_radius, 0);
        }
        array.recycle();
    }

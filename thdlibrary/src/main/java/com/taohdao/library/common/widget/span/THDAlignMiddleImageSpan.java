 ...
 * @date 2016-03-17
 */
public class THDAlignMiddleImageSpan extends ImageSpan {
     ...
     */
    public THDAlignMiddleImageSpan(Drawable d, int verticalAlignment) {
     ...
     */
    public THDAlignMiddleImageSpan(Drawable d, int verticalAlignment, float fontWidthMultiple) {

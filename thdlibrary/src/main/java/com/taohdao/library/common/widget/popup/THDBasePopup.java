 ...
 */
public abstract class THDBasePopup {
    private static final String TAG = "THDBasePopup";
     ...
     */
    public THDBasePopup(Context context) {
        mContext = context;
    ...
    protected int makeWidthMeasureSpec() {
        return View.MeasureSpec.makeMeasureSpec(ScreenUtils.getScreenWidth(), View.MeasureSpec.AT_MOST);
    }

    protected int makeHeightMeasureSpec() {
        return View.MeasureSpec.makeMeasureSpec(ScreenUtils.getScreenHeight(), View.MeasureSpec.AT_MOST);
    }
    ...
    public class RootView extends ViewGroup {
        ...
        protected void onConfigurationChanged(Configuration newConfig) {
            ...
            THDBasePopup.this.onConfigurationChanged(newConfig);
        }

...
public class THDViewHelper {
    ...
    public static void afterCursor(TextView view) {
    ...
    public static void playViewBackgroundAnimation(final View v, @ColorInt int startColor, @ColorInt int endColor, long duration, int repeatCount, int setAnimTagId, final Runnable endAction) {
        ...
        THDViewHelper.setBackgroundColorKeepPadding(v, startColor);
        ...
        anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                THDViewHelper.setBackgroundColorKeepPadding(v, (Integer) animation.getAnimatedValue());
            }
        });
        if (setAnimTagId != 0) {
     ...
     * <p>相关方法 {@link #(View, int, Animation.AnimationListener, boolean, )}</p>
     *
     * @param view            做动画的 View
     * @param duration        动画时长(毫秒)
     * @param listener        动画回调
    ...
    public static
    @Nullable
    TranslateAnimation slideIn(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, THDDirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
     ...
     * <p>相关方法 {@link #slideIn(View, int, Animation.AnimationListener, boolean, THDDirection)}</p>
     *
     * @param view            做动画的 View
     * @param duration        动画时长(毫秒)
     * @param listener        动画回调
    ...
    public static
    @Nullable
    TranslateAnimation slideOut(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, THDDirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
    ...
    public static void slideOut(final View view, float end, int duration, THDDirection direction) {
        ...
        switch (direction) {
            case LEFT_TO_RIGHT:
                break;
            case TOP_TO_BOTTOM:
                animator = ValueAnimator.ofFloat(end, 0).setDuration(duration);
                break;
            case RIGHT_TO_LEFT:
                break;
            case BOTTOM_TO_TOP:
                ...
                animator = ValueAnimator.ofFloat(0, end).setDuration(duration);
                break;
        }
        if(animator == null){
            return;
    ...
    public static void slideIn(final View view, float end, int duration, THDDirection direction) {
        final ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
        if (layoutParams.topMargin >= 0) {
            return;
        }
        ValueAnimator animator = ValueAnimator.ofFloat(end, 0).setDuration(duration);
        animator.setEvaluator(new FloatEvaluator());
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {

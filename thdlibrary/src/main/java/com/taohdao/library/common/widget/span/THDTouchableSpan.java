...
import com.taohdao.library.common.widget.link.ITouchableSpan;
 ...
 * </p>
 */
public abstract class THDTouchableSpan extends ClickableSpan implements ITouchableSpan {
    ...
    public THDTouchableSpan(@ColorInt int normalTextColor,

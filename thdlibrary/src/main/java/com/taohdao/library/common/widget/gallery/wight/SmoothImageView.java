package com.taohdao.library.common.widget.gallery.wight;
...
import com.taohdao.library.common.widget.gallery.view.ImageUtils;

import uk.co.senab.photoview.UKPhotoView;
 ...
 * Deprecated: 缩放图片
 ***/
public class SmoothImageView extends UKPhotoView {

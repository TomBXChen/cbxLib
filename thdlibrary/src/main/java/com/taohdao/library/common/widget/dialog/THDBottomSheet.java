...
public class THDBottomSheet extends Dialog {
    ...
    public THDBottomSheet(Context context) {
        super(context, R.style.THD_BottomSheet);
    }
    ...
    public static class BottomListSheetBuilder {
        ...
        private THDBottomSheet mDialog;
        ...
        public THDBottomSheet build() {
            mDialog = new THDBottomSheet(mContext);
        ...
        private boolean needToScroll() {
            int itemHeight = THDResHelper.getAttrDimen(mContext, R.attr.thd_bottom_sheet_list_item_height);
            ...
            if (mTitleTv != null && !THDLangHelper.isNullOrEmpty(mTitle)) {
                totalHeight += THDResHelper.getAttrDimen(mContext, R.attr.thd_bottom_sheet_title_height);
            }
        ...
        protected int getContentViewLayoutId() {
            return R.layout.thd_bottom_sheet_list;
        }

        public interface OnSheetItemClickListener {
            void onClick(THDBottomSheet dialog, View itemView, int position, String tag);
        }
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    convertView = inflater.inflate(R.layout.thd_bottom_sheet_list_item, parent, false);
    ...
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        public BottomGridSheetBuilder addItem(int imageRes, CharSequence text, Object tag, @Style int style, int subscriptRes) {
            THDBottomSheetItemView itemView = createItemView(AppCompatResources.getDrawable(mContext, imageRes), text, tag, subscriptRes);
        ...
        public THDBottomSheetItemView createItemView(Drawable drawable, CharSequence text, Object tag, int subscriptRes) {
            LayoutInflater inflater = LayoutInflater.from(mContext);
            THDBottomSheetItemView itemView = (THDBottomSheetItemView) inflater.inflate(R.layout.thd_bottom_sheet_grid_item, null, false);
        ...
        private View buildViews() {
            ...
            if (mBottomButton != null) {
                if (mIsShowButton) {
                    ...
                    int dimen = THDResHelper.getAttrDimen(mContext, R.attr.thd_bottom_sheet_grid_padding_vertical);
        ...
        protected int getContentViewLayoutId() {
            return R.layout.thd_bottom_sheet_grid;
        }
        ...
        private int calculateItemWidth(int width, int maxItemCountInEachLine, int paddingLeft, int paddingRight) {
            if (mMiniItemWidth == -1) {
                mMiniItemWidth = THDResHelper.getAttrDimen(mContext, R.attr.thd_bottom_sheet_grid_item_mini_width);
            }
        ...
        public interface OnSheetItemClickListener {
            void onClick(THDBottomSheet dialog, View itemView);
        }

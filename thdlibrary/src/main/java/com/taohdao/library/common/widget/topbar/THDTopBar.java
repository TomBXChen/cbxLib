...
public class THDTopBar extends RelativeLayout {
    ...
    public THDTopBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initVar();
        init(context, attrs, defStyleAttr);
    }

    public THDTopBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.THDTopBarStyle);
    }


    // ========================= centerView 相关的方法

    public THDTopBar(Context context) {
        this(context, null);
    }
    ...
    THDTopBar(Context context, boolean inTopBarLayout, int leftBackDrawableRes) {
        super(context);
        initVar();
        if (inTopBarLayout) {
            int transparentColor = ContextCompat.getColor(context, R.color.thd_config_color_transparent);
            ...
            init(context, null, R.attr.THDTopBarStyle);
            mLeftBackDrawableRes = leftBackDrawableRes;
        }
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.THDTopBar, defStyleAttr, 0);
        mTopBarSeparatorColor = array.getColor(R.styleable.THDTopBar_thd_topbar_separator_color,
                ContextCompat.getColor(context, R.color.thd_config_color_separator));
        mTopBarSeparatorHeight = array.getDimensionPixelSize(R.styleable.THDTopBar_thd_topbar_separator_height, 1);
        mTopBarBgColor = array.getColor(R.styleable.THDTopBar_thd_topbar_bg_color, Color.WHITE);
        mLeftBackDrawableRes = array.getResourceId(R.styleable.THDTopBar_thd_topbar_left_back_drawable_id, R.id.thd_topbar_item_left_back);
        mTitleGravity = array.getInt(R.styleable.THDTopBar_thd_topbar_title_gravity, Gravity.CENTER);
        boolean hasSeparator = array.getBoolean(R.styleable.THDTopBar_thd_topbar_need_separator, true);
        array.recycle();
    ...
    protected void onAttachedToWindow() {
        ...
        while (parent != null && (parent instanceof View)) {
            if (parent instanceof THDCollapsingTopBarLayout) {
    ...
    public TextView setTitle(String title) {
        ...
        if (THDLangHelper.isNullOrEmpty(title)) {
...
//            mTitleView = isEmoji ? new EmojiconTextView(getContext()) : new TextView(getContext());
            ...
            mTitleView.setTextColor(THDResHelper.getAttrColor(getContext(), R.attr.thd_topbar_title_color));
    ...
    private void updateTitleViewStyle() {
        if (mTitleView != null) {
            if (mSubTitleView == null || THDLangHelper.isNullOrEmpty(mSubTitleView.getText())) {
                mTitleView.setTextSize(TypedValue.COMPLEX_UNIT_PX, THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_title_text_size));
            } else {
                mTitleView.setTextSize(TypedValue.COMPLEX_UNIT_PX, THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_title_text_size_with_subtitle));
            }
        }
    }
    ...
    public void setSubTitle(String subTitle) {
        ...
        if (THDLangHelper.isNullOrEmpty(subTitle)) {
            titleView.setVisibility(GONE);
        } else {
            titleView.setVisibility(VISIBLE);
        }
    ...
    private TextView getSubTitleView() {
        if (mSubTitleView == null) {
            ...
            mSubTitleView.setTextSize(TypedValue.COMPLEX_UNIT_PX, THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_subtitle_text_size));
            mSubTitleView.setTextColor(THDResHelper.getAttrColor(getContext(), R.attr.thd_topbar_subtitle_color));
            LinearLayout.LayoutParams titleLp = generateTitleViewAndSubTitleViewLp();
            titleLp.topMargin = SizeUtils.dp2px(1);
    ...
    public Rect getTitleContainerRect() {
        ...
        if (mTitleContainerView == null) {
            ...
            THDViewHelper.getDescendantRect(this, mTitleContainerView, mTitleContainerRect);
        }
    ...
    private LinearLayout makeSureTitleContainerView() {
        if (mTitleContainerView == null) {
            ...
            int horPadding = THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_title_container_padding_horizontal);
    ...
    private LayoutParams generateTitleContainerViewLp() {
        return new LayoutParams(LayoutParams.MATCH_PARENT,
                THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_height));
    }
    ...
    public AlphaImageButton addRightImageButton(int drawableResId, int viewId) {
        AlphaImageButton rightButton = generateTopBarImageButton(drawableResId);
    ...
    public AlphaImageButton addLeftImageButton(int drawableResId, int viewId) {
        AlphaImageButton leftButton = generateTopBarImageButton(drawableResId);
    ...
    private Button generateTopBarTextButton(String text) {
        ...
        button.setTextColor(THDResHelper.getAttrColorStateList(getContext(), R.attr.thd_topbar_text_btn_color_state_list));
        button.setTextSize(TypedValue.COMPLEX_UNIT_PX, THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_text_btn_text_size));
     ...
     */
    private AlphaImageButton generateTopBarImageButton(int imageResourceId) {
        AlphaImageButton backButton = new AlphaImageButton(getContext());
    ...
    public AlphaImageButton addLeftBackImageButton() {
        return addLeftImageButton(mLeftBackDrawableRes, R.id.thd_topbar_item_left_back);
    }
    ...
    private int getTopBarHeight() {
        if (mTopbarHeight == -1) {
            mTopbarHeight = THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_height);
        }
    ...
    protected int getTopBarImageBtnWidth() {
        if (mTopbarImageBtnWidth == -1) {
            mTopbarImageBtnWidth = THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_image_btn_height);
        }
    ...
    protected int getTopBarImageBtnHeight() {
        if (mTopbarImageBtnHeight == -1) {
            mTopbarImageBtnHeight = THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_image_btn_height);
        }
    ...
    private int getTopBarTextBtnPaddingHorizontal() {
        if (mTopbarTextBtnPaddingHorizontal == -1) {
            mTopbarTextBtnPaddingHorizontal = THDResHelper.getAttrDimen(getContext(), R.attr.thd_topbar_text_btn_padding_horizontal);
        }
    ...
    public void setBackgroundDividerEnabled(boolean enabled) {
        if (enabled) {
            if (mTopBarBgWithSeparatorDrawableCache == null) {
                mTopBarBgWithSeparatorDrawableCache = THDDrawableHelper.
                        createItemSeparatorBg(mTopBarSeparatorColor, mTopBarBgColor, mTopBarSeparatorHeight, false);
            }
            THDViewHelper.setBackgroundKeepingPadding(this, mTopBarBgWithSeparatorDrawableCache);
        } else {
            THDViewHelper.setBackgroundColorKeepPadding(this, mTopBarBgColor);
        }
    }
        ...
        if (mTitleContainerView != null) {
            ...
            if ((mTitleGravity & Gravity.HORIZONTAL_GRAVITY_MASK) == Gravity.CENTER_HORIZONTAL) {
                if (leftViewWidth == 0 && rightViewWidth == 0) {
                    ...
                    int titleMarginHorizontalWithoutButton = THDResHelper.getAttrDimen(getContext(),
                            R.attr.thd_topbar_title_margin_horizontal_when_no_btn_aside);
                ...
                if (leftViewWidth == 0) {
                    leftViewWidth += THDResHelper.getAttrDimen(getContext(),
                            R.attr.thd_topbar_title_margin_horizontal_when_no_btn_aside);
                }
                if (rightViewWidth == 0) {
                    rightViewWidth += THDResHelper.getAttrDimen(getContext(),
                            R.attr.thd_topbar_title_margin_horizontal_when_no_btn_aside);
                }
        ...
        if (mTitleContainerView != null) {
            ...
            if ((mTitleGravity & Gravity.HORIZONTAL_GRAVITY_MASK) == Gravity.CENTER_HORIZONTAL) {
                ...
                if (mLeftViewList.isEmpty()) {
                    //左侧没有按钮，标题离左侧间距
                    titleContainerViewLeft += THDResHelper.getAttrDimen(getContext(),
                            R.attr.thd_topbar_title_margin_horizontal_when_no_btn_aside);
                }
            }

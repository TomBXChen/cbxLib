 ...
 * 无法根据具体需求进行底部对齐或者顶部对齐。而 THDTextSizeSpan 则可以多传一个参数，让你可以根据具体情况来决定偏移值。
 *
 * @author cginechen
 * @date 2016-12-02
 */

public class THDTextSizeSpan extends ReplacementSpan {
    private int mTextSize;
    private int mVerticalOffset;
    private Paint mPaint;

    public THDTextSizeSpan(int textSize, int verticalOffset){
        mTextSize = textSize;

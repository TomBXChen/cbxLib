...
public abstract class THDItemViewsAdapter<T, V extends View> {
    ...
    public THDItemViewsAdapter(ViewGroup parentView) {
    ...
    public void detach(int count) {
        ...
        while (childCount > 0 && count > 0) {
            ...
            Object notCacheTag = view.getTag(R.id.thd_view_can_not_cache_tag);
    ...
    public THDItemViewsAdapter<T, V> addItem(T item) {
        mItemData.add(item);
        return this;
    }

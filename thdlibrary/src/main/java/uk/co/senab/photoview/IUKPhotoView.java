...
public interface IUKPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(UKPhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(UKPhotoViewAttacher.OnPhotoTapListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(UKPhotoViewAttacher.OnViewTapListener listener);
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (UKPhotoViewAttacher.DEFAULT_ZOOM_DURATION).
    ...
    /**
     * Will return instance of IUKPhotoView (eg. UKPhotoViewAttacher), can be used to provide better
     * integration
     *
     * @return IUKPhotoView implementation instance if available, null if not
     */
    IUKPhotoView getIPhotoViewImplementation();

    /**
     * Sets custom double tap listener, to intercept default given functions. To reset behavior to
     * default, you can just pass in "null" or public field of UKPhotoViewAttacher.defaultOnDoubleTapListener
     *
     ...
     */
    void setOnScaleChangeListener(UKPhotoViewAttacher.OnScaleChangeListener onScaleChangeListener);
     ...
     */
    void setOnSingleFlingListener(UKPhotoViewAttacher.OnSingleFlingListener onSingleFlingListener);
}
